...
import WheelOfLifeApp from './techniques/WheelOfLife';
import EnergetickyKotel from './techniques/EnergetickyKotel';
import DisneyModel from './techniques/DisneyModel';
import ThreeAdvisorsApp from './techniques/ThreeAdvisors';
...
const TECHNIQUES = [
  {
    ...
    icon: Target,
    color: '#ff8474',
    component: WheelOfLifeApp,
    theory: {
      origin: 'Kolo rovnováhy (Wheel of Life) je jedním z nejpoužívanějších koučovacích nástrojů na světě. Jeho původ sahá do 60. let 20. století a je spojován s Paulem J. Meyerem, zakladatelem Success Motivation Institute.',
  ...
  },
  {
    ...
    theory: {
      ...
      definition: 'Logické úrovně jsou vnitřní hierarchií, v níž každý stupeň je postupně stále více psychologicky ucelenější a vlivnější. Model zahrnuje 5 úrovní: Prostředí, Chování, Schopnosti, Hodnoty a Identita.',
      keyPoints: [
...
// ============================================
// SPOLEČNÝ HEADER PRO TECHNIKY
// ============================================
export const TechniqueHeader = ({ techniqueName, onBack }) => (
  <div className="bg-white border-b border-[#e5ddd2] sticky top-0 z-40 no-print">
    <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-4">
      ...
      <div className="flex items-center gap-2">
        <Sparkles size={18} className="text-[#ff8474]" />
...
// ============================================
// WRAPPER PRO TECHNIKY
// ============================================
const TechniqueWrapper = ({ technique, onBack }) => {
  const TechniqueComponent = technique.component;
  
  return (
    <div className="min-h-screen bg-[#FAF6F2]">
      <TechniqueHeader techniqueName={technique.name} onBack={onBack} />
      <TechniqueComponent />
    </div>
  );
};
